...
import com.jesselopez.joybundler.repositories.UserRepository;
...
public class UserService {
	...
	//---------------user serv end---------------------------------//
	//-----------------logreg services start-----------//
    // TO-DO: Write register and login methods!
    public User register(User newUser, BindingResult results) {
        // TO-DO: Additional validations!
    	//Check to see if email is already is taken
    	if(this.checkEmail(newUser.getEmail())) {
    		results.rejectValue("email", "EmailTaken", "Email Already Exists");
    	}
